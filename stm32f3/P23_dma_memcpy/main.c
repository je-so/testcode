...
int main(void)
{
   ...
   for (;;) {
      ...
      assert( 3<<12 == (dma->channel[CH1].ccr & HW_BIT_DMA_CCR_PL_MASK));
      assert( 2<<12 == (dma->channel[CH2].ccr & HW_BIT_DMA_CCR_PL_MASK));
      assert( 1<<12 == (dma->channel[CH3].ccr & HW_BIT_DMA_CCR_PL_MASK));
      assert( 0<<12 == (dma->channel[channel].ccr & HW_BIT_DMA_CCR_PL_MASK));
      assert( 0 == enable_dma(dma, channel));
      ...
      assert( 0<<12 == (dma->channel[CH1].ccr & HW_BIT_DMA_CCR_PL_MASK));
      assert( 0<<12 == (dma->channel[CH2].ccr & HW_BIT_DMA_CCR_PL_MASK));
      assert( 0<<12 == (dma->channel[CH3].ccr & HW_BIT_DMA_CCR_PL_MASK));
      assert( 0<<12 == (dma->channel[channel].ccr & HW_BIT_DMA_CCR_PL_MASK));
      assert( 0 == enable_dma(dma, CH3));
      assert( 0 == enable_dma(dma, CH2));
      assert( 0 == enable_dma(dma, CH1));
      ...
      assert( 3<<12 == (DMA1->channel[CH1].ccr & HW_BIT_DMA_CCR_PL_MASK));
      assert( 3<<12 == (DMA1->channel[CH2].ccr & HW_BIT_DMA_CCR_PL_MASK));
      assert( 0<<12 == (DMA2->channel[CH1].ccr & HW_BIT_DMA_CCR_PL_MASK));
      assert( 0<<12 == (DMA2->channel[CH2].ccr & HW_BIT_DMA_CCR_PL_MASK));
