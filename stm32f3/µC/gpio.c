...
#define HW_OFF_SYSCFG_EXTICR1 0x08
...
#define HW_OFF_SYSCFG_EXTICR2 0x0C
...
#define HW_OFF_SYSCFG_EXTICR3 0x10
...
#define HW_OFF_SYSCFG_EXTICR4 0x14
...
static void select_interrupt_port(uint8_t portnr, uint16_t pins)
{
   ...
   static_assert( HW_OFF_SYSCFG_EXTICR1 + 4 == HW_OFF_SYSCFG_EXTICR2
                  && HW_OFF_SYSCFG_EXTICR2 + 4 == HW_OFF_SYSCFG_EXTICR3
                  && HW_OFF_SYSCFG_EXTICR3 + 4 == HW_OFF_SYSCFG_EXTICR4);
