...
#define HW_KONFIG_USER_LED_PORT        GPIO_PORTE
#define HW_KONFIG_USER_LED_PORT_BIT    GPIO_PORTE_BIT
#define HW_KONFIG_USER_LED_PINS        GPIO_PINS(HW_KONFIG_USER_LED_MAXPIN, HW_KONFIG_USER_LED_MINPIN)
#define HW_KONFIG_USER_LED_MINPIN      8
#define HW_KONFIG_USER_LED_MAXPIN      15

#define HW_KONFIG_USER_SWITCH_NROF     1
#define HW_KONFIG_USER_SWITCH_PORT     GPIO_PORTA
#define HW_KONFIG_USER_SWITCH_PORT_BIT GPIO_PORTA_BIT
