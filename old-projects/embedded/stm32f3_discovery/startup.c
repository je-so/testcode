/* title: startup-STM32F303xC impl

   C implementation of startup code for STM32F303xC based board.
...
uint32_t g_NVIC_vectortable[98] __attribute__ ((section(".rom_address_0x0"))) = {
