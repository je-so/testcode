...
int main(void)
{
   ...
   setprioritymask_interrupt(interrupt_priority_LOW);   // prevent scheduler interrupt to be activated
   ...
   setpriority_coreinterrupt(coreinterrupt_SYSTICK, interrupt_priority_LOW-1);   // could preempt scheduler
