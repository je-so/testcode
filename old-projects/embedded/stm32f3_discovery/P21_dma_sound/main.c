...
int main(void)
{
   ...
   assert( (DAC1->cr & HW_REGISTER_BIT_DAC_CR_DMAEN1) == 0);
   assert( (DAC1->cr & HW_REGISTER_BIT_DAC_CR_DMAEN2) == 0);
   assert( (DAC1->cr & HW_REGISTER_BIT_DAC_CR_EN1) != 0);
   assert( (DAC1->cr & HW_REGISTER_BIT_DAC_CR_EN2) == 0);
   assert( (DAC1->cr & HW_REGISTER_BIT_DAC_CR_TEN1) != 0);
   assert( (DAC1->cr & HW_REGISTER_BIT_DAC_CR_TEN2) == 0);
   assert( (DAC1->cr & HW_REGISTER_BIT_DAC_CR_TSEL1_MASK) == 2 << HW_REGISTER_BIT_DAC_CR_TSEL1_POS);
   ...
   assert( (DAC1->cr & HW_REGISTER_BIT_DAC_CR_TEN2) != 0);
   assert( (DAC1->cr & HW_REGISTER_BIT_DAC_CR_TSEL1_MASK) == 2 << HW_REGISTER_BIT_DAC_CR_TSEL1_POS);
   assert( (DAC1->cr & HW_REGISTER_BIT_DAC_CR_TSEL2_MASK) == 5 << HW_REGISTER_BIT_DAC_CR_TSEL2_POS);
   ...
   assert( (DAC1->cr & HW_REGISTER_BIT_DAC_CR_TEN1) == 0);
   assert( (DAC1->cr & HW_REGISTER_BIT_DAC_CR_TEN2) == 0);
   assert( (DAC1->cr & HW_REGISTER_BIT_DAC_CR_TSEL1_MASK) == 0 << HW_REGISTER_BIT_DAC_CR_TSEL1_POS);
   assert( (DAC1->cr & HW_REGISTER_BIT_DAC_CR_TSEL2_MASK) == 0 << HW_REGISTER_BIT_DAC_CR_TSEL2_POS);
   ...
   assert( (DAC1->cr & HW_REGISTER_BIT_DAC_CR_TEN2) != 0);
   assert( (DAC1->cr & HW_REGISTER_BIT_DAC_CR_TSEL1_MASK) == 0 << HW_REGISTER_BIT_DAC_CR_TSEL1_POS);
   assert( (DAC1->cr & HW_REGISTER_BIT_DAC_CR_TSEL2_MASK) == 7 << HW_REGISTER_BIT_DAC_CR_TSEL2_POS);
