...
#define UART4 ((uart_t*)HW_BASEADDR_UART4)
#define UART5 ((uart_t*)HW_BASEADDR_UART5)
...
#define HW_BIT_USART_CR1_M10_MASK ((1u << 28) | (1u << 12))
#define HW_BIT_USART_CR1_M10_7    ((1u << 28) | 0) // not supported
#define HW_BIT_USART_CR1_M10_8    (0          | 0)
#define HW_BIT_USART_CR1_M10_9    (0          | (1u << 12))
/* Bit 10 PCE: Parity control enable
 * 0: Parity control disabled, 1: Parity control enabled
 * Bit 9 PS: Parity selection
 * 0: Even parity, 1: Odd parity */
#define HW_BIT_USART_CR1_PARITY_MASK  (3u << 9)
#define HW_BIT_USART_CR1_PARITY_OFF   (0)
#define HW_BIT_USART_CR1_PARITY_EVEN  (2u << 9)
#define HW_BIT_USART_CR1_PARITY_ODD   (3u << 9)

/* Bits 13:12 STOP[1:0]: STOP bits
 * These bits are used for programming the stop bits.
 * 00: 1 stop bit, 01: 0.5 stop bit, 10: 2 stop bits, 11: 1.5 stop bits */
#define HW_BIT_USART_CR2_STOP_MASK (3u << 12)
#define HW_BIT_USART_CR2_STOP_1    (0)
#define HW_BIT_USART_CR2_STOP_2    (2u << 12)
...
static inline int config_uart(uart_t *uart, uint8_t databits/*7..9*/, uint8_t parity/*0:no,1:odd,2:even*/, uint8_t stopbits/*1..2*/, uint32_t baudrate/*bits per sec*/)
{
   ...
   uart->cr1 = 0; // disable
   uint32_t cr1 = HW_BIT_USART_CR1_M10_8;
   if (nrbits == 9) {
      cr1 = HW_BIT_USART_CR1_M10_9;
   }
   static_assert(HW_BIT_USART_CR1_PARITY_OFF == 0);
   if (parity) {
      cr1 |= parity&1 ? HW_BIT_USART_CR1_PARITY_ODD : HW_BIT_USART_CR1_PARITY_EVEN;
   }
   uart->cr1 = cr1;
   uart->cr2 = stopbits ? HW_BIT_USART_CR2_STOP_2 : HW_BIT_USART_CR2_STOP_1;
   uart->cr3 = 0;
   uart->brr = usartdiv;
   cr1 |= 1  // enable UART
        | 4  // enable receiver
