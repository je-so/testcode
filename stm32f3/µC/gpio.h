...
#define GPIOA ((gpio_port_t*)HW_BASEADDR_GPIOA)
#define GPIOB ((gpio_port_t*)HW_BASEADDR_GPIOB)
#define GPIOC ((gpio_port_t*)HW_BASEADDR_GPIOC)
#define GPIOD ((gpio_port_t*)HW_BASEADDR_GPIOD)
#define GPIOE ((gpio_port_t*)HW_BASEADDR_GPIOE)
#define GPIOF ((gpio_port_t*)HW_BASEADDR_GPIOF)
...
{
   static_assert((((uintptr_t)HW_BASEADDR_GPIOA >> 10)&0x7) == 0);
   static_assert((((uintptr_t)HW_BASEADDR_GPIOB >> 10)&0x7) == 1);
   static_assert((((uintptr_t)HW_BASEADDR_GPIOC >> 10)&0x7) == 2);
   static_assert((((uintptr_t)HW_BASEADDR_GPIOD >> 10)&0x7) == 3);
   static_assert((((uintptr_t)HW_BASEADDR_GPIOE >> 10)&0x7) == 4);
   static_assert((((uintptr_t)HW_BASEADDR_GPIOF >> 10)&0x7) == 5);
